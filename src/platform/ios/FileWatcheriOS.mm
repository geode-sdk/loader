...
FileWatcheriOS::FileWatcheriOS(ghc::filesystem::path const& file, FileWatchCallback callback, ErrorCallback error) {
...
bool FileWatcheriOS::watching() const {
